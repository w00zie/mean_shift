...
int main(int argc, char *argv[]){
    ...
    constexpr auto eps = constants::case_1000::eps;
    // I/O
    constexpr auto num_points = constants::case_1000::num_points;
    constexpr auto dim = constants::dim;
    constexpr auto num_centroids = constants::num_centroids;
    const auto data_path = constants::case_1000::data_path;
    const auto centroids_path = constants::case_1000::centroids_path;
    ...
    const std::vector<mean_shift::vec<float, dim>> centroids = mean_shift::seq::cluster_points<float, num_points, dim>(data, niter, bandwidth, radius, min_distance, eps);    
