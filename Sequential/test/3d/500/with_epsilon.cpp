...
int main(int argc, char *argv[]){
    ...
    constexpr auto eps = constants::case_500::eps;
    // I/O
    constexpr auto num_points = constants::case_500::num_points;
    constexpr auto dim = constants::dim;
    constexpr auto num_centroids = constants::num_centroids;
    const auto data_path = constants::case_500::data_path;
    const auto centroids_path = constants::case_500::centroids_path;
