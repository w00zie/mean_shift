...
// Dataset
constexpr auto N = mean_shift::cuda::bench_3d::case_1000::N;
constexpr auto D = mean_shift::cuda::bench_3d::D;
constexpr auto M = mean_shift::cuda::bench_3d::M;
const auto PATH_TO_DATA = mean_shift::cuda::bench_3d::case_1000::PATH_TO_DATA; 
const auto PATH_TO_CENTROIDS = mean_shift::cuda::bench_3d::case_1000::PATH_TO_CENTROIDS;
const auto LOG_NAIVE = mean_shift::cuda::bench_3d::case_1000::LOG_NAIVE;
// Hyperparams
constexpr auto RADIUS = mean_shift::cuda::bench_3d::case_1000::RADIUS;
constexpr auto NUM_ITER = mean_shift::cuda::bench_3d::NUM_ITER;
constexpr auto DBL_SIGMA_SQ = mean_shift::cuda::bench_3d::case_1000::DBL_SIGMA_SQ;
constexpr auto MIN_DISTANCE = mean_shift::cuda::bench_3d::case_1000::MIN_DISTANCE;
// Device
constexpr auto THREADS = mean_shift::cuda::bench_3d::THREADS;
constexpr auto BLOCKS = mean_shift::cuda::bench_3d::case_1000::BLOCKS;
