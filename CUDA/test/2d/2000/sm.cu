...
// Dataset
constexpr auto N = mean_shift::cuda::test_2d::case_2000::N;
constexpr auto D = mean_shift::cuda::test_2d::case_2000::D;
constexpr auto M = mean_shift::cuda::test_2d::M;
const auto PATH_TO_DATA = mean_shift::cuda::test_2d::case_2000::PATH_TO_DATA; 
const auto PATH_TO_CENTROIDS = mean_shift::cuda::test_2d::case_2000::PATH_TO_CENTROIDS;
// Hyperparams
constexpr auto RADIUS = mean_shift::cuda::test_2d::case_2000::RADIUS;
constexpr auto MIN_DISTANCE = mean_shift::cuda::test_2d::case_2000::MIN_DISTANCE;
constexpr auto NUM_ITER = mean_shift::cuda::test_2d::NUM_ITER;
constexpr auto DBL_SIGMA_SQ = mean_shift::cuda::test_2d::case_2000::DBL_SIGMA_SQ;
constexpr auto DIST_TO_REAL = mean_shift::cuda::test_2d::DIST_TO_REAL;
// Device
constexpr auto THREADS = mean_shift::cuda::test_2d::THREADS;
constexpr auto BLOCKS = mean_shift::cuda::test_2d::case_2000::BLOCKS;
constexpr auto TILE_WIDTH = mean_shift::cuda::test_2d::case_2000::TILE_WIDTH;
