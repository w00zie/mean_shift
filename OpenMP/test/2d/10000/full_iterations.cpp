...
int main(int argc, char *argv[]) {
    ...
    const size_t dim = 2;
    const std::string data_path = "../../../../datasets/2d/10000_samples_3_centers/data.csv";
    const std::string centroids_path = "../../../../datasets/2d/10000_samples_3_centers/centroids.csv";
    // Final check
