...
#include "../files_bench_2d.h"
#include <thread>

// Hyperparameters
constexpr auto bandwidth = constants::case_1000::bandwidth;
constexpr auto radius = constants::case_1000::radius;
constexpr auto min_distance = constants::case_1000::min_distance;
...
const auto out_file = constants::case_1000::out_file;
