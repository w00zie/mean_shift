...
int main() {
    ...
    if (eps > 0) {
        ...
        const std::vector<mean_shift::vec<float, dim>> centroids = mean_shift::omp::cluster_points<float, num_points, dim>(data, niter, bandwidth, radius, min_distance, eps. num_threads);    
